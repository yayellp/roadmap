  ...
  def plan_params
    params.require(:plan)
          .permit(:org_id, :org_name, :funder_id, :funder_name, :template_id,
                  :title, :visibility, :grant_number, :description,
                  :identifier, :principal_investigator, :data_contact,
                  :principal_investigator_phone, :data_contact_email,
                  :principal_investigator_email, :data_contact_phone,
